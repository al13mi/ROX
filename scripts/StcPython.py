class StcPython:    
    def __init__(self, STC_INSTALL_DIR):
        ...
        if sys.hexversion < 0x020605F0:            
            raise ImportError, "This version of StcPython requires Python version 2.6.5 or greater."

        if sys.hexversion >= 0x03000000:
            print("\\nWarning: This version of StcPython does not officially support Python 3.0 and greater.\\n")

        try:            
            os.environ['STC_PRIVATE_INSTALL_DIR'] = STC_INSTALL_DIR
        except:
            #raise "Please replace STC_INSTALL_DIR with the actual STC install directory first."
            raise "Please check your STC_INSTALL_DIR."
